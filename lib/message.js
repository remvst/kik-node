...
class Message {
    ...
    /**
     *  See https://dev.kik.com/docs/messages#text
     *  @return {Message}
     */
    static text(text) {
    ...
    /**
     *  See https://dev.kik.com/docs/messages#link
     *  @return {Message}
     */
    static link(link) {
    ...
    /**
     *  See https://dev.kik.com/docs/messages#picture
     *  @return {Message}
     */
    ...
    /**
     *  See https://dev.kik.com/docs/messages#video
     *  @return {Message}
     */
    ...
    /**
     *  See https://dev.kik.com/docs/messages#isTyping
     *  @return {Message}
     */
    ...
    /**
     *  See https://dev.kik.com/docs/messages#receipts
     *  @return {Message}
     */
    ...
    /**
     *  See https://dev.kik.com/docs/messages#start-chatting
     *  @return {boolean}
     */
    ...
    /**
     *  See https://dev.kik.com/docs/messages#scan-data
     *  @return {boolean}
     */
    isScanDataMessage() {
    ...
    /**
     *  See https://dev.kik.com/docs/messages#sticker
     *  @return {boolean}
     */
    isStickerMessage() {
    ...
    /**
     *  See https://dev.kik.com/docs/messages#is-typing
     *  @return {boolean}
     */
    isIsTypingMessage() {
    ...
    /**
     *  See https://dev.kik.com/docs/messages#delivery-receipt
     *  @return {boolean}
     */
    ...
    /**
     *  See https://dev.kik.com/docs/messages#read-receipt
     *  @return {boolean}
     */
    ...
    /**
     *  See https://dev.kik.com/docs/messages#mentions
     *  @return {boolean}
     */
    isMention() {
        return !!(this.mention || this.mention.length !== 0);
    }
    ...
    /**
     *  See https://dev.kik.com/docs/messages#from
     *  @return {string}
     */
    get from() {
    ...
    /**
     *  See https://dev.kik.com/docs/messages#id
     *  @return {string}
     */
    get id() {
    ...
    /**
     *  See https://dev.kik.com/docs/messages#chatId
     *  @return {string}
     */
    get chatId() {
    ...
    /**
     *  See https://dev.kik.com/docs/messages#messageIds
     *  @return {string}
     */
    get messageIds() {
    ...
    /**
     *  See https://dev.kik.com/docs/messages#readReceiptRequested
     *  @return {string}
     */
    ...
    /**
     *  See https://dev.kik.com/docs/messages#stickerPackId
     *  @return {string}
     */
    get stickerPackId() {
    ...
    /**
     *  See https://dev.kik.com/docs/messages#stickerUrl
     *  @return {string}
     */
    get stickerUrl() {
    ...
    /**
     *  See https://dev.kik.com/docs/messages#timestamp
     *  @return {string}
     */
    get timestamp() {
    ...
    /**
     *  See https://dev.kik.com/docs/messages#type
     *  @return {string}
     */
    get type() {
    ...
    /**
     *  See https://dev.kik.com/docs/messages#kikJsData
     *  @return {string}
     */
    get kikJsData() {
    ...
    /**
     *  See https://dev.kik.com/docs/messages#picUrl
     *  @return {string}
     */
    get picUrl() {
    ...
    /**
     *  See https://dev.kik.com/docs/messages#noForward
     *  @return {string}
     */
    get noForward() {
    ...
    /**
     *  See https://dev.kik.com/docs/messages#body
     *  @return {string}
     */
    get body() {
    ...
    /**
     *  See https://dev.kik.com/docs/messages#title
     *  @return {string}
     */
    get title() {
    ...
    /**
     *  See https://dev.kik.com/docs/messages#url
     *  @return {string}
     */
    get url() {
    ...
    /**
     *  See https://dev.kik.com/docs/messages#videoUrl
     *  @return {string}
     */
    get videoUrl() {
    ...
    /**
     *  See https://dev.kik.com/docs/messages#delay
     *  @return {string}
     */
    get delay() {
    ...
    /**
     *  See https://dev.kik.com/docs/messages#typeTime
     *  @return {string}
     */
    get typeTime() {
    ...
    /**
     *  See https://dev.kik.com/docs/messages#attribution
     *  @return {string}
     */
    get attributionName() {
    ...
    /**
     *  See https://dev.kik.com/docs/messages#loop
     *  @return {boolean}
     */
    get loop() {
    ...
    /**
     *  See https://dev.kik.com/docs/messages#muted
     *  @return {boolean}
     */
    get muted() {
    ...
    /**
     *  See https://dev.kik.com/docs/messages#autoplay
     *  @return {boolean}
     */
    get autoplay() {
    ...
    /**
     *  See https://dev.kik.com/docs/messages#noSave
     *  @return {boolean}
     */
    get noSave() {
    ...
    /**
     *  See https://dev.kik.com/docs/messages#participants
     *  @return {array}
     */
    get participants() {
    ...
    /**
     *  See https://dev.kik.com/docs/messages#mention
     *  @return {string}
     */
    get mention() {
